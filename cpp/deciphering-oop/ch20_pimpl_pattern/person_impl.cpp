...
// copy constructor -- in member init list, call PersonImpl copy constructor with new nested object
// creation
Person::Person(const Person &p) : pImpl(new PersonImpl(*(p.pImpl))) {
  ...
  // pImpl = new PersonImpl(*(p.pImpl));  // call PersonImpl copy constructor with new nested object
  // creation
}
