...
int main() {
  ...
  // we insert a Student one position past the front of our deque
  // Note, operator= is called both by insert (twice) and in the explicit
  // assignment on the line below insert
  studentBody.insert(std::next(studentBody.begin()),
                     Student("Anne", "Brennan", 'B', "Ms.", 3.9, "C++", "299CU"));
