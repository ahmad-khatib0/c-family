...
int main() {
  ...
  // internally and will properly clean up these objects when they are no longer
  // members of the list. You are responsible to delete and heap instances you provide
  // to the list when you are done with them.
  ...
  // They are anonymous objects -- this is ok, they are directly added and copied
  // in the container and the local copies in main will be propertly popped off the
  // stack once added to the list.
