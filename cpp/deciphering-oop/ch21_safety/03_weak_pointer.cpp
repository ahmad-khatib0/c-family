...
// Note: could also include: using std::make_shared; if you don't want 
// to qualify use below with std::
...
int main() {
  ...
  // note: weak pointer can not access the resource, must use a shared pointer to do so
  // wpers1->Print(); 
