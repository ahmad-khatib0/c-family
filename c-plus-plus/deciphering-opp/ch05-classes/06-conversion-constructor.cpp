...
Employee::Employee() // default constructor
{
  ...
  // constructed and hence 'empty' by default. They HAVE been initialized.
  salary = 0.0;
}
...
// Eventually, we can properly const qualify parameter, but we’ll need to learn
// about const member functions first…
...
// default constructor
Student::Student() {
  // even though string data members, firstName and lastName, are initialized with
  // empty strings (string is a class and does so for us), it is considered better
  // practice to ensure that we initialize all data members within our constructor
  firstName = "";
  lastName = "";
  middleInitial = '\0';
  gpa = 0.0;
...
int main() {
  ...
  e1.Print();
  s1.CleanUp(); // CleanUp() will delete() s1's dynamically allocated data members
  return 0;
}
