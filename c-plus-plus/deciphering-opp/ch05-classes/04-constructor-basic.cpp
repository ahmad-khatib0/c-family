...
{
  // Because a string is a class type, all strings are constructed with an empty
  // value by default. For that reason, we do not need to explicitly initialize
  // strings if an empty string is desired.
  numStudents = 0;
}
...
int main() {
  ...
  // also uses alternate constructor - note use of {}'s
